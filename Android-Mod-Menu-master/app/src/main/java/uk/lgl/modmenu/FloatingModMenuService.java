...
public class FloatingModMenuService extends Service {
    ...
    final int MENU_WIDTH = 285;
    final int MENU_HEIGHT = 225;
    ...
    private void initFloating() {
        ...
        gdMenuBody.setStroke(1, Color.parseColor("#FF1112")); //Set border
        ...
        relativeLayout.setPadding(5, 3, 10, 3);
        relativeLayout.setVerticalGravity(Gravity.CENTER);

        Button hideBtn = new Button(this);
        //gradientdrawable1.setCornerRadius(200); //Set corner
        //gradientdrawable1.setColor(Color.WHITE); //Set background color
        //gradientdrawable1.setStroke(1, Color.RED); //Set border
        //closeBtn.setBackground(gradientdrawable1); //Enables Gradient
		hideBtn.setTextSize(20.0f);
        ...
        //closeBtn.setText("                                   CLOSE                                  "); //In case you want close button only
		closeBtn.setTextSize(20.0f);
    ...
    private void SeekBar(final int featureNum, final String featureName, final int min, int max) {
        ...
        final TextView textView = new TextView(this);
        textView.setText(Html.fromHtml("<font face='roboto'>" + featureName + ": <font color='#000000'>" + ((loadedProg == 0) ? min : loadedProg) + "</font>"));
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
                ...
                textView.setText(Html.fromHtml("<font face='roboto'>" + featureName + ": <font color='#09FF1B'>" + (i < min ? min : i) + "</font>"));
            }
        });
    ...
    private void Button(final int featureNum, final String featureName) {
		...
		gradientdrawable3.setCornerRadius(20); //Set corner
		gradientdrawable3.setColor(Color.TRANSPARENT); //Set background color
		gradientdrawable3.setStroke(5, Color.parseColor("#ffffff")); //Set border
    ...
    private void ButtonLink(final String featureName, final String url) {
        ...
        gradientdrawable4.setCornerRadius(20); //Set corner
        gradientdrawable4.setColor(Color.TRANSPARENT); //Set background color
        gradientdrawable4.setStroke(3, Color.BLUE); //Set border
    ...
    private void ButtonOnOff(final int featureNum, String featureName) {
        ...
        if (isActive) {
			...
			gradientdrawable7.setStroke(2, Color.GREEN); //Set border
			...
			gradientdrawable7.setStroke(2, Color.RED); //Set border
			//gradientdrawable.setSize(MENU_WIDTH, MENU_HEIGHT);
			button.setBackground(gradientdrawable7);
    ...
    private void Category(String text) {
		...
		TextView textView = new TextView(this);
		int start = Color.parseColor("#FFFFFF");
		int end = Color.parseColor("#D4D4D4");
		Shader shader = new LinearGradient(0, 0, 40, textView.getLineHeight(),
										   start, end, Shader.TileMode.MIRROR);
		textView.getPaint().setShader(shader);
		GradientDrawable gradientdrawable = new GradientDrawable();
		gradientdrawable.setCornerRadius(5); //Set corner
		gradientdrawable.setColor(Color.RED); //Set background color
		gradientdrawable.setStroke(1, Color.RED); //Set border
    ...
    public void startAnimation() {
        final int start = Color.parseColor("#FF0103");
        final int end = Color.parseColor("#FF05B0");
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
				...
				//int newStrat1 = (int) evaluator.evaluate(fraction, start, end);
                int newEnd = (int) evaluator.evaluate(fraction, end, start);
				//int newEnd1 = (int) evaluator.evaluate(fraction, end1, start1);
                int[] newArray = {newStrat, newEnd};
				//int[] newArray1 = {newStrat1, newEnd1};
                gradient.setColors(newArray);
				//gradient.setColors(newArray1);
            }
        });
